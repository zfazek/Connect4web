...
{
	static int table[X_SIZE * Y_SIZE];
	copy_table(t, table);
...
static int get_number_of_wins_per_first_move(int *table,
					     const int *orig_table,
					     const int m,
					     const int color,
...
static int get_best_move_monte_carlo(const int *t,
				     const int color, const int number_of_games)
{
